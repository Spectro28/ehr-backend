...
exports.createCita = async (req, res) => {
    try {
      ...
      const cita = await Cita.create({
        ...
        fields: ['id', 'pacienteId', 'consultorioId', 'doctorId', 'fecha', 'hora', 'estado', 'notas', 'created_at', 'updated_at'],
        returning: ['id', 'pacienteId', 'consultorioId', 'doctorId', 'fecha', 'hora', 'estado', 'notas', 'created_at', 'updated_at']
      });
