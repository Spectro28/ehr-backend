...
exports.getMedicamentos = async (req, res) => {
    try {
        ...
        console.log('DEBUG: Medicamentos obtenidos en catálogos:', medicamentos.map(m => ({
            id: m.id,
...
exports.searchMedicamentos = async (req, res) => {
    try {
        ...
        console.log('DEBUG: Medicamentos encontrados en búsqueda de catálogos:', allMedicamentos.map(m => ({
            id: m.id,
            nombre_generico: m.nombre_generico,
            nombre_comercial: m.nombre_comercial,
            nombres_comerciales: m.nombres_comerciales?.map(nc => nc.nombre_comercial) || []
