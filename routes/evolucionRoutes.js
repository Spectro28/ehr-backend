...
// Proteger rutas que requieren ser médico, doctor o dentista
router.use(checkRole(['medico', 'doctor', 'dentista']));
...
router.get('/medico/pacientes-clasificados', evolucionController.getPacientesPorMedico);
router.get('/medico/pacientes-con-signos', evolucionController.getPacientesConSignosPorMedico);
